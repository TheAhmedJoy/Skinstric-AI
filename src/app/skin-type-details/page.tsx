...
import SkinTypeDetailsChart from "../components/SkinTypeDetailsChart"
...
export default function SkinTypeDetailsPage() {
  return (
        ...
        <div className="md:h-full max-w-full mx-5 px-4 md:px-auto flex flex-col min-h-0">
          <div className="text-start ml-4 mb-4 md:mb-10 md:ml-0">
            ...
            <h4 className={`text-sm mt-2 leading-6 ${roobertFontRegular.className}`}>
              SKIN TYPE CLASSIFICATION ASSESSMENT
            </h4>
          </div>

          <SkinTypeDetails>
            <SkinTypeDetailsChart />
          </SkinTypeDetails>
